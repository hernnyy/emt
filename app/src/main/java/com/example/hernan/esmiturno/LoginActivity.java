...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        registryButton.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent (contexto, RegistryActivity.class);
...
//                                intent.putExtra("id",jsonResp.getString("id"));
        ...
        SignInButton signInButton = (SignInButton) findViewById(R.id.sign_in_button_g);
...
//                                intent.putExtra("id",jsonResp.getString("id"));
            ...
            NetManager.getInstance(mctx).addToRequestQueue(strRequest);
